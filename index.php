<html lang="en">
    ...
    <body>
        ...
        <form method="post">
            ...
            <input type="number" id="guess" name="guess" min="1" max="100" step="1" required <input type="number" id="num" name="num" value="<?php if (isset($_POST['guess'])) echo $_POST['guess']; ?>" required>>
